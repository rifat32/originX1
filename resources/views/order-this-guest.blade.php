   ...
   <nav class="nav-menu mobile-menu">
    ...
    <section class="checkout-section spad">
        <div class="container">
            ...
            <form class="checkout-form" action="{{route('place.order.Guest')}}" method="POST">
                <div class="row">
            ...
            @csrf  
                    ...
                    <div class="col-lg-6">
                                ...
                                <input maxlength="30" id="userName" required name="userName" type="text" placeholder="Type your Name here">
