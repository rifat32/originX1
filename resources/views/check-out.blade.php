            ...
            @csrf  
                    <input name="userName" id="userName" value="{{ Auth::user()->name }}"  type="hidden" >
                     ...
                     <div class="col-lg-12">
                                ...
                                <input id="userAddress" required name="userAddress" type="text"  class="street-first" placeholder="Type your address here">
                            ...
                            <div class="col-lg-6">
                                ...
                                <input id="userPhone" required name="userPhone" type="text" placeholder="Type your address here">
                        ...
                        <div class="place-order">
                            ...
                            <div class="order-total">
                                <ul class="order-table">
                                    ...
                                    <li class="fw-normal">{{$datas->productName}} x {{$datas->productQuantity}} <span>{{$datas->productTotalPrice}}</span></li>
                                    @endforeach
                                
                                    <li class="total-price">Total <span>{{$personCart[0]->total}}</span></li>
                                </ul>
                               
                               @if($personCart[0]->total == 0)
                               <a href="#" class="btn btn-dark py-3">Select Product First. Than Yo will see Place Order Option</a>
                               @else
