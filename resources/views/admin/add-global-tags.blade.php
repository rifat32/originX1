   ...
   <ul class="d-flex flex-wrap">
                 ...
                 <li><a href="/admin-panel/admin-view-services">View Services</a> 
                    ...
                    <li><a href="/admin-panel/all-products">All Products</a>  
                     ...
                     <li class="active"><a href="/admin-panel/add-global-tags">Add Global Tag</a>  
                        </li>
...
<div class="card">
    ...
    <div class="card-body">
        @if(Session::has('global-tag-added'))
        <div class="alert alert-success" role="alert">{{Session::get('global-tag-added')}}</div>
        @endif
      
        <form action="{{route('globalTag.store')}}" method="POST" >
    @csrf 
    
    <div class="form-group">
        <lebel for="tag">Tag Name (only one)</lebel>
        <input required type="text" id="tag" name="tag" class="form-control">
    </div>
    <div class="form-group">
        <lebel for="tagFor">Tag For</lebel> 
        <select id="tagFor" name="tagFor" class="form-control">
            @foreach($services as $service)
