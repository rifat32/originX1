...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="alert alert-success" role="alert">{{Session::get('category-updated')}}</div>
        @endif
      
        <form action="{{route('productCategory.update')}}" method="POST" >
    @csrf 
    <input type="hidden" name="id" value="{{$category->id}}">
    <input type="hidden" name="service" value="{{$category->service}}">
    <div class="form-group">
        <lebel for="category">Category Name</lebel>
        <input value="{{$category->category}}" required type="text" id="category" name="category" class="form-control">
    </div>
