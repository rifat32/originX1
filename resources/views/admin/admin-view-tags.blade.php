                 ...
                 <li><a href="/admin-panel/admin-view-services">View Services</a> 
                    ...
                    <li><a href="/admin-panel/all-products">All Products</a>  
                     ...
                     <li><a href="/admin-panel/add-global-tags">Add Global Tag</a>  
                        ...
                        <li><a class="myActive" href="#">View Global Tags</a>  
                        <ul class="dropdown">
                            @foreach($services as $service)
                            <li><a
                   ...
                   class="myActive"
                 @endif
                            href="/admin-panel/admin-view-tags/{{$service->service}}">{{$service->service}}</a></li>
                            @endforeach
...
<div class="card">
    ...
    @if(Session::has('tag-deleted'))
        <div class="alert alert-success" role="alert">{{Session::get('tag-deleted')}}</div>
        @endif
...
<tr>
    ...
    <td>
        <a href="/admin-panel/edit-tag/{{$tag->id}}" class="btn btn-info">Edit</a>
        <a href="/admin-panel/delete-tag/{{$tag->id}}" class="btn btn-danger">Delete</a>
        </td>
