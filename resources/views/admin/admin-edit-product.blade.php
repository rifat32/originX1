...
<div class="card">
    ...
    <div class="form-group">
        ...
        <textarea required name="descriptionIntroduction" class="form-control" id="descriptionIntroduction"  rows="4" >{{$product->descriptionIntroduction}}</textarea>
    </div>
    <div class="form-group">
        <lebel for="descriptionIntroduction">Product Description Features (Required)</lebel>
        <textarea required name="descriptionFeatures" class="form-control" id="descriptionFeatures"  rows="4">{{$product->descriptionFeatures}}</textarea>
    </div>
    <div class="form-group">
        <lebel for="currentPrice">Current Price (Required)</lebel>
        <input required type="text" name="currentPrice" id="currentPrice"  class="form-control" value="{{$product->currentPrice}}">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <textarea required name="tags" class="form-control" id="tags"  rows="2">{{$product->tags}}</textarea>
    </div>
    <div class="form-group">
