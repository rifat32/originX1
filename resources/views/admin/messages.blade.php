...
<x-html-head/>
  ...
  <header class="header-section">
   ...
   <ul class="d-flex flex-wrap">
                 ...
                 <li class="active"><a href="/admin-panel/admin-view-services">View Services</a> 
                        </li>
...
<div class="card">
    ...
    @if(Session::has('message-deleted'))
        <div class="alert alert-success" role="alert">{{Session::get('message-deleted')}}</div>
        @endif
...
<tr>
    <td style="width:1px;">{{$message->userName}}</td>
    <td style="width:1px;">{{$message->userEmail}}</td>
    <td style="width:500px;">{{$message->userMessage}}</td>
    <td style="width:1px;">{{$message->created_at}}</td>
  
     <td>
      
        <a href="/admin-panel/delete-message/{{$message->id}}" class="btn btn-danger">Delete</a>
        </td>
