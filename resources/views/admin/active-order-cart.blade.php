...
<div class="card">
    ...
    @if(Session::has('cart-deleted'))
        <div class="alert alert-success" role="alert">{{Session::get('cart-deleted')}}</div>
        @endif
...
<tr>
    <td><a href="/product/{{$cart->productId}}"><img style="max-width:100px;" src="/ProductImages/{{$cart->productImage}}" alt="product"></a></td>
    ...
    <td>
    <a href="/admin-panel/delete-cart-admin/{{$cart->id}}" class="btn btn-danger">Delete</a>
       </td>
