  ...
  <header class="header-section">
   ...
   <ul class="d-flex flex-wrap">
                 ...
                 <li><a href="/admin-panel/admin-view-services">View Services</a> 
                    ...
                    <li><a class="myActive" href="#">View Product Categories</a>
                    <ul class="dropdown">
                   ...
                   class="myActive"
                 @endif
                            href="/admin-panel/admin-view-categories/{{$service->service}}">{{$service->service}}</a></li>
                            @endforeach
...
<div class="card">
    ...
    @if(Session::has('category-deleted'))
        <div class="alert alert-success" role="alert">{{Session::get('category-deleted')}}</div>
        @endif
...
<tr>
    ...
    <td>
        <a href="/admin-panel/edit-category/{{$category->id}}" class="btn btn-info">Edit</a>
        <a href="/admin-panel/delete-category/{{$category->id}}" class="btn btn-danger">Delete</a>
        </td>
