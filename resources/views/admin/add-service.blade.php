<x-html-head/>
  ...
  <header class="header-section">
   ...
   <ul class="d-flex flex-wrap">
                    ...
                    <li class="active"><a href="/admin-panel/add-service">Add Service</a> 
                        </li>
...
<div class="card">
    ...
    <div class="card-body">
        @if(Session::has('service-added'))
        <div class="alert alert-success" role="alert">{{Session::get('service-added')}}</div>
        @endif
      
        <form action="{{route('service.store')}}" method="POST"  >
    @csrf 
    <div class="form-group">
        <lebel for="service">Service Name</lebel>
        <input required type="text" id="service" name="service" class="form-control">
    </div>
