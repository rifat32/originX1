...
<div class="card">
    ...
    @if(Session::has('service-deleted'))
        <div class="alert alert-success" role="alert">{{Session::get('service-deleted')}}</div>
        @endif
...
<tr>
    ...
    <td>
        <a href="/admin-panel/edit-service/{{$service->id}}" class="btn btn-info">Edit</a>
        <a href="/admin-panel/delete-service/{{$service->id}}" class="btn btn-danger">Delete</a>
        </td>
