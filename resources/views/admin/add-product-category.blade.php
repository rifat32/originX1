  ...
  <header class="header-section">
   ...
   <ul class="d-flex flex-wrap">
                 ...
                 <li><a href="/admin-panel/admin-view-services">View Services</a> 
                        ...
                        <li class="active"><a href="/admin-panel/add-product-category">Add Product Category</a>
...
<div class="card">
    ...
    <div class="card-body">
        @if(Session::has('product-category-added'))
        <div class="alert alert-success" role="alert">{{Session::get('product-category-added')}}</div>
        @endif
    ...
    <div class="form-group">
        ...
        <input required type="text" id="category" name="category" class="form-control">
    </div>
    <div class="form-group">
        <lebel for="categoryFor">Choose Service (Default is now {{$services[0]->service}})</lebel> 
        <select id="categoryFor" name="categoryFor" class="form-control">
            @foreach($services as $service)
